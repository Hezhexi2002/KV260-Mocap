...
**Note:I have added the master branch of MocapNET as a submodule in my repository which can lead you to find the repo quickly and I have compressed my compiled MocapNET as a zip file which can be directly used without building the MocapNET in the next steps as long as you have  install the dependencies above,you can download it from my BaiduNetdisk(link：https://pan.baidu.com/s/1GSDoZUsgv_fFSi_jMRMKQg 
pwd：1234) **
